# Updated power switch script to avoid ghost signals on GPIO when
# plugin/unplugin USB devices.
# Author: supernature2k (Recalbox forum)
# Src: https://forum.recalbox.com/topic/6996/bouton-gpio-quitter-%C3%A9mulateur/15
